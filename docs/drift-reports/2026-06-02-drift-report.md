...
**Branch**: `dev`
**Scanned at**: 2026-06-02T02:50:54.879Z
...
- `packages/validators/src/clerk-env.ts`
  Validator `clerk-env` has undocumented env vars: `CLERK_APP_ID`, `CLERK_INSTANCE_ID` — add to OPERATIONS.md Environment Variables
...
- `packages/validators/src/observability-env.ts`
  Validator `observability-env` has undocumented env vars: `VERCEL_TEAM_ID`, `VERCEL_DOMAIN` — add to OPERATIONS.md Environment Variables
  → Update: docs/OPERATIONS.md
