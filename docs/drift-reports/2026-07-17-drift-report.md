# Documentation Drift Report — 2026-07-17

**Branch**: `dev`
**Scanned at**: 2026-07-17T05:44:36.310Z
**Total items requiring attention**: 29

## Action Items

- Add 17 new route(s) to ARCHITECTURE.md API Routes table and OPERATIONS.md
- Document 6 undocumented env var(s) in OPERATIONS.md Environment Variables table
...
- `packages/validators/src/devops-env.ts`
  Validator `devops-env` has undocumented env vars: `ANTHROPIC_API_KEY`, `GITHUB_TOKEN`, `GITHUB_WEBHOOK_SECRET`, `SENTRY_WEBHOOK_SECRET`, `GITHUB_BRANCH` — add to OPERATIONS.md Environment Variables
  → Update: docs/OPERATIONS.md
...
- `packages/validators/src/observability-env.ts`
  Validator `observability-env` has undocumented env vars: `SENTRY_AUTH_TOKEN`, `SENTRY_ORG`, `SENTRY_PROJECT`, `SENTRY_TOKEN`, `VERCEL_API_TOKEN`, `VERCEL_PROJECT_ID`, `VERCEL_TEAM_ID`, `VERCEL_DOMAIN`, `VERCEL_AUTOMATION_BYPASS_SECRET` — add to OPERATIONS.md Environment Variables
  → Update: docs/OPERATIONS.md
- `packages/validators/src/qstash-env.ts`
  Validator `qstash-env` has undocumented env vars: `QSTASH_CURRENT_SIGNING_KEY`, `QSTASH_NEXT_SIGNING_KEY` — add to OPERATIONS.md Environment Variables
  → Update: docs/OPERATIONS.md
