...
import { DOPPLER_SECRET_IDS, ENVIRONMENT_RESOURCES, KNOWN_RESOURCE_IDS, RESOURCE_ID_HINTS, RESOURCES, } from "./tf.resources.js";
function isAlreadyManagedMessage(text) {
...
const command = async () => {
    ...
    for (const key of resources) {
        ...
        const knownId = typeof rawKnownId === "function" ? rawKnownId(env) : rawKnownId;
        if (hint) {
            console.log(`\n  ℹ ${key}: ${hint}`);
        }
        if (knownId) {
