...
export const RESOURCES = {
    ...
    vercel_production: "module.vercel_platform.vercel_project_domain.production[0]",
    ...
    vercel_home_production: "module.vercel_home.vercel_project_domain.production[0]",
    ...
    cloudflare_dev_portfolio: "module.cloudflare.cloudflare_dns_record.dev_portfolio[0]",
    cloudflare_resume_api: "module.cloudflare.cloudflare_dns_record.resume_api[0]",
    cloudflare_career_data: "module.cloudflare.cloudflare_dns_record.career_data[0]",
...
function byEnv(ids) {
    return (env) => (env === "production" ? ids.production : ids.preview);
}
...
export const KNOWN_RESOURCE_IDS = {
    ...
    vercel_home_preview: "team_Jmi4R7XA5pi7uK4Br6j9IJkg/prj_WPaRoz5atNtcPTlYg5lzJ9eT4JJU/dev.portfolio.dw-portfolio.dev",
    vercel_home_production: "team_Jmi4R7XA5pi7uK4Br6j9IJkg/prj_WPaRoz5atNtcPTlYg5lzJ9eT4JJU/portfolio.dw-portfolio.dev",
    ...
    cloudflare_dev_portfolio: "145e64e1bd9e74d45fd610490d6d91fe/4da31557b75ca0094516581b81b763a2",
    cloudflare_resume_api: "145e64e1bd9e74d45fd610490d6d91fe/6e0099be12ea99a62b8d76d3cd5709f2",
    cloudflare_career_data: "145e64e1bd9e74d45fd610490d6d91fe/dd1676b62fa0384f6ed545a3a9655688",
...
export const RESOURCE_ID_HINTS = {
    ...
    cloudflare_portfolio: "Format: zone_id/record_id — may not exist yet, check first",
    cloudflare_dev_portfolio: "Format: zone_id/record_id — may not exist yet, check first",
...
export const ENVIRONMENT_RESOURCES = {
    preview: [
        "upstash",
        "supabase",
        "vercel_preview",
